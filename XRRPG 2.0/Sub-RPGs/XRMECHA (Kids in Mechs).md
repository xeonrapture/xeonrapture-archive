...
Make sure you bring the following to a game of XRMECHA:

- An internet-connected device to use for rules and/or your character sheet (like a laptop, phone, tablet, etc.)
- One d100 and 3-5 d20
- Google doc or pencil and paper for you character sheet if you'd like
- Snacks!
- Drinks!
- Ambiance (music, a galaxy light generator, some WD-40 to make the room smell like an engineering bay, whatever you need to get in the mood)

In addition make sure you're ready to get into the nitty-gritty of parts and stats! Making a mech is mostly looking at lists of parts and calculating which ones can fit within your Load Limit and how they'll affect your stats. For battle get ready to think strategically and outwit your opponents.

# General Rules

The mechs you'll be building are the Valdan variety, 100-150 tons, 3-6 stories tall (~40-80 ft), and extremely modular. They're built for adaptability and work just as well in space as they do on the ground.
...
| HP              | Mech health!                                                                                                 |
| Armor HP        | How much HP your armor has, some armor only blocks certain types of damage. Recharges in about an hour.      |
| Load Limit      | How much weight in parts your mech can hold.                                                                 |
| Weight          | How heavy your mech is right now.                                                                            |
...
| Range           | Each gun's effective gun range is derived from this stat.                                                    |
...
| --------- | ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Head      | Aim, Range                   | Head determines aim and range, and can be specialized for navigation, targeting, or special sensors.                                                                                                                          |
...
| Armor     | Armor HP                     | Armor adds some HP on top of your base HP, some armor blocks physical or xenic damage.                                                                                                                                        |
...
| Guns      | -                            | Guns do damage, pew pew. Some powerful guns have a Charge Speed, which is how many turns you need to use a quick action before using.<br>Each gun's effective range is derived from your Range stat.<br>Roll Aim stat to use. |
| Swords    | -                            | Swords do damage, swish swish. Roll Str or Agi stat to use.                                                                                                                                                                   |
...
| Drones    | -                            | Drones do everything from healing, shooting, or firing lasers. Roll Aim stat to attack.<br>Each drone's effective range is derived from your Range stat.                                                                      |
| Modules   | -                            | Adds other capabilities, such as hacking, drones, or atmosphere generation. You are able to install more modules as you gain more Pilot Levels.                                                                               |
...
As you grow as a pilot you get better at piloting your mech, and better at modifying your mech with upgrades and modules. You get new Specializations as you level up as a pilot, which happens as you go on missions, gain experience, and pilot your mech.

You have Pilot Specializations equal to your Pilot Level! Pilot Level has a max of 5, and every time you level up you may trade one Specialization in for another.

**Very important:** You may only use one attack-amplifying ability per attack! (Applies only to abilities from Pilot Specializations and Mech Upgrades.)
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------- |
| **Stat Specs**     | -                                                                                                                                           |
| Health Up          | Increase your HP by 25%.                                                                                                                |
| Agility Up         | Increase Agility by 25%.                                                                                                                |
| Strength Up        | Increase Strength by 25%.                                                                                                               |
| Durability Up      | Increase Durability by 25%.                                                                                                             |
| Aim Up             | Increase Aim by 25%.                                                                                                                    |
| Range Up           | Increase Range by 100%.                                                                                                                 |
| **Load Specs**     | -                                                                                                                                           |
| Lighten the Load   | Increase your Load Limit by 25%.                                                                                                        |
| Module Master      | You may install an extra Module.                                                                                                            |
| Upgrade Specialist | You may install two extra Upgrades.                                                                                                         |
| Armor Aficionado   | You may install an extra set of Armor.                                                                                                      |
| Drone Expert       | You may increase the total drones you can dock by 50% (rounded down).                                                                       |
| **Ability Specs**  | -                                                                                                                                           |
| Energy Booster     | You may gain Energy equal to your Energy Gain (3/day).                                                                                          |
| Protective Shield  | You may defend an ally against an attack (you use your own Defense DC against the attack) (3/day).                                          |
| Energized Attack   | You may do a minimum Energy attack that uses up to your full Energy Capacity's worth of Energy (3/day).                                     |
| **Other**          | -                                                                                                                                           |
...
| Energy Sap                | You spend an extra energy on an attack to siphon off and take half the enemy's current energy.<br>Refunds the ability use if attack doesn't hit but *does not* refund the energy spent.     | 2/day |
...
| Boost Attack              | You may double the damage you do but you take the original damage amount yourself.                                                                                                          | 2/day |
...
Initiative is decided by each individual person rolling an Agility roll and whoever gets highest goes first, then next etc. etc.

Out of combat you always have Energy equal to your Energy Gain stored up, so when you enter combat this is how much you'll start with.
...
- Opportunity Attack: Yes! When any enemy exits your melee range you may roll to hit them. Enemies can do this to you as well!
...
For example, I'm using Strength to defend, so my Defense DC is 50 + 35 (Str) = 85 because I don't have any extra defense bonuses. My opponent rolls a 93 to hit, so they hit me!
...
Armor is a little bank of HP on top of your core HP, and some armor only blocks certain types of damage:
- Xenic armor only blocks xenic attacks (like heat and cold beams) and is only depleted by xenic attacks.
- Onyx armor only blocks physical attacks and is only depleted by physical attacks, but is resistant against physical. Onyx armor completely blocks obsidian attacks.
- Standard armor blocks and is depleted by all types of attacks.

A mech can only ever have one set of armor on at one time unless otherwise stated! And armor regenerates fully after an hour since it was last damaged.
...
If for any reason you ever don't have thrusters your move speed is 100 ft per turn.

### Range

Each gun has a Range Rating that determines how to calculate their effective range. Standard Range is 300 ft.

Shooting an enemy that's out of your effective range is done with disadvantage.

Some guns have combination ranges, such as Close-Medium, or Medium-Far. These ranges take the **closest** Minimum Range and the **farthest** Maximum range (e.g. Close-Medium has a Min Range of 50 ft and a Max Range of your Range stat).

| Range Rating | Min Range | Max Range |
| ------------ | --------- | --------- |
| Close        | 50 ft     | Range / 2 |
| Medium       | 150 ft    | Range     |
| Far          | 300 ft    | Range x 2 |
| Unlimited    | 30 ft     | None      |

Drones typically just use the Medium Range Rating for how far they can shoot, though some drones might be different. Drones can travel distance equal to your Range away from your mech, and can be as close to you as you'd like.

### Cover

Being behind cover reduces the damage you take! The amount of coverage you have is what percent of your body is shielded or not visible by an enemy.

Full cover means you take 0 dmg (100% coverage), 75% coverage means you take 25% damage, half coverage means you take 50% damage, and quarter coverage means you take 75% damage. 

If you'd like you can use stranger percentages (such as 98.454% coverage to take 1.546% damage), but the weirder it gets the harder it is to calculate!
...
Weapons need to be in-hand to charge up.
...
Below are the costs (in credits) to repair your mech up to full after it takes damage.

| Repair Threshold | Repair Cost      |
| ---------------- | ---------------- |
| 100%-75% HP      | Highest Stat x 1 |
| 75%-50% HP       | Highest Stat x 2 |
| 50%-25% HP       | Highest Stat x 3 |
| 25%-1% HP        | Highest Stat x 4 |
| Totalled         | Highest Stat x 5 |

### Getting Totaled

If your mech reaches 0 HP your mech has gotten totaled! Your escape pod will attempt to eject automatically.

The pod has 50 HP and 50 Agi to dodge. You get 100 ft of movement that you can use immediately after your mech gets totaled.

When your mech reaches 0 HP you roll a d10. 
- On a 2-10 you eject and are in the escape pod. 
- On a 1 the ejection fails and you take 2d12 dmg and, if you fall unconscious with that damage, you roll another d10:
	- 6-10: You're knocked out and are inflicted with the [[Critical Injuries#Blunt Trauma|Blunt Trauma Critical Injury]], start doing death saves!
	- 2-5: You're knocked out and are inflicted with the [[Critical Injuries#Bleeding Out|Bleeding Out Critical Injury]], start doing death saves!
	- 1: MAIMED
		- You're inflicted with the [[Critical Injuries#Maimed|Maimed Critical Injury]]! You might lose a limb or something.
